...
class Penguin(arcade.AnimatedTimeSprite):
    def __init__(self):
        ...
        self.textures.append(arcade.load_texture("images/penguin1.png"))
        self.textures.append(arcade.load_texture("images/penguin2.png"))
        self.textures.append(arcade.load_texture("images/penguin3.png"))
    def update(self):
...
class MyGame(arcade.Window):
    def __init__(self, width, height, title):
        ...
        self.background = arcade.load_texture("images/space_hack.png")
